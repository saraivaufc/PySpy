...
class Ui_MainWindow(QtGui.QMainWindow):
	...
	def setupUi(self, MainWindow):
		...
		self.connectMicrofone = QtGui.QPushButton(self.centralwidget)
		self.connectMicrofone.setCheckable(False)
		self.connectMicrofone.setObjectName(_fromUtf8("connectMicrofone"))
		self.horizontalLayout_2.addWidget(self.connectMicrofone)
		self.disconnectMicrofone = QtGui.QPushButton(self.centralwidget)
		self.disconnectMicrofone.setObjectName(_fromUtf8("disconnectMicrofone"))
		self.horizontalLayout_2.addWidget(self.disconnectMicrofone)
	...
	def retranslateUi(self, MainWindow):
		...
		self.connectMicrofone.setText(_translate("MainWindow", "Connect", None))
		self.disconnectMicrofone.setText(_translate("MainWindow", "Disconnect", None))
	...
	def requestAudio(self, size):
		th=Thread( target=self.streamAudio,
					args = (self.__server_connected,size) )
		th.start()
